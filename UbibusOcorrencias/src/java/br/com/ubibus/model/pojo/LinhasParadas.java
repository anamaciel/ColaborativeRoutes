...
public class LinhasParadas implements Serializable {
    ...
    @JoinColumn(name = "id_paradas", referencedColumnName = "id_parada", insertable = false, updatable = false)
    @ManyToOne(optional = false)
    private Parada parada;
    @JoinColumn(name = "id_linhas", referencedColumnName = "id_linha", insertable = false, updatable = false)
    @ManyToOne(optional = false)
    private Linha linha;
