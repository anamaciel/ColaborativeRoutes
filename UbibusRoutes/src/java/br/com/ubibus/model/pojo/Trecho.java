...
public class Trecho implements Serializable {
    ...
    public String getLocalizacaoOrigemDestino() {
        LatLng coord1 = new LatLng(this.paradaOrigem.getLocalizacao().getFirstPoint().getY(), this.paradaOrigem.getLocalizacao().getFirstPoint().getX()); 
        LatLng coord2 = new LatLng(this.paradaDestino.getLocalizacao().getFirstPoint().getY(), this.paradaDestino.getLocalizacao().getFirstPoint().getX());         
