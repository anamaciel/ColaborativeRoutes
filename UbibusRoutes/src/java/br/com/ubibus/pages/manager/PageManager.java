...
public class PageManager {
    ...
    //private String paginaAtiva = "./pages/pontosParadasOnibus.xhtml";
    private String paginaAtiva = "./pages/rotasColaborativas.xhtml";
    ...
    private String listaRotas = "./components/listaRotas.xhtml";
    ...
    public String getListaRotas() {
        return listaRotas;
    }

    public void setListaRotas(String listaRotas) {
    ...
    public String setMapAddRotas() {
        this.paginaAtiva = "./pages/addPontosParadasProximas.xhtml";
        setPageMap(true);
        return "refreshPage";
    }
